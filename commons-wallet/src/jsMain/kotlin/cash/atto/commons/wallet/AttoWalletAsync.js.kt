...
actual class AttoWalletAsync internal actual constructor(
    ...
    suspend fun openAccount(indexes: Array<AttoKeyIndex>): Array<AttoWalletAccount> = wallet.openAccount(indexes.toList()).toTypedArray()

    @JsName("openAccountRange")
    suspend fun openAccount(
        fromIndex: AttoKeyIndex,
        toIndex: AttoKeyIndex,
    ): Array<AttoWalletAccount> = wallet.openAccount(fromIndex, toIndex).toTypedArray()
