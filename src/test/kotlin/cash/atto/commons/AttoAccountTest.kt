...
class AttoAccountTest {
    ...
    fun `should serialize json`() {
        // given
        val expectedAccount = AttoAccount(
    ...
    fun `should deserialize json`() {
        // given
        val expectedJson =
            """{"publicKey":"45B3B58C26181580EEAFC1791046D54EEC2854BF550A211E2362761077D6590C","version":0,"algorithm":"V1","height":1,"balance":18000000000000000000,"lastTransactionHash":"70F9406609BCB2E3E18F22BD0839C95E5540E95489DC6F24DBF6A1F7CFD83A92","lastTransactionTimestamp":"2024-01-17T18:45:57.478253100Z","representative":"99E439410A4DDD2A3A8D0B667C7A090286B8553378CF3C7AA806C3E60B6C4CBE"}"""
