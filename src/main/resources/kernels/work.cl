...
enum IV_Derived {
    xor_iv0 = 0x6a09e667f2bdc900UL,  // iv1 ^ 0x1010000 ^ outlen
    xor_iv4 = 0x510e527fade682f9UL,  // iv4 ^ inbytes
    xor_iv6 = 0xe07c265404be4294UL,  // iv6 ^ ~0
};
...
static inline ulong blake2b(ulong const nonce, __constant ulong *hash)
{
    ulong2 vv[8] = {
        {xor_iv0, iv1}, {iv2, iv3},          {iv4, iv5},
        {iv6, iv7},          {iv0, iv1},          {iv2, iv3},
        {xor_iv4, iv5}, {xor_iv6, iv7},
    };
